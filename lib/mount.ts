import { Component, ComponentInput } from '../@types/index.js'
import { render } from './render.js'

export const mount = (root: HTMLElement, input: ComponentInput | null, renderedComponent?: Component) => {
  ...
  // TODO: again, ensure that this is really a Component
  if (!renderedComponent) renderedComponent = render(input!) as Component
